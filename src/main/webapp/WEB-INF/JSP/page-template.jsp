      ...
      <div class="sticky categories show-for-large" data-sticky
        ...
        <table>
          <tbody>
            ...
            <tr>
              <td><a href="/news">Consectetuer<span>(33)</span></a>
              </td>
            </tr>
            <tr>
    ...
    <div class="row">
      <div class="small-12 medium-6 large-5 columns">
        ...
        <p class="footer-links">
          <a href="/news">News</a> <a href="#">Search</a> <a
      ...
      <div class="small-12 medium-6 large-4 columns">
        <ul class="contact">
          <li><p>
              <i class="fi-marker"></i>1234 Spring Street New York, CT
              00001
            </p></li>
          <li><p>
      ...
      <div class="small-12 medium-12 large-3 columns">
        ...
        <p class="about subheader">A blog is a discussion or
          informational site published on the World Wide Web consisting
